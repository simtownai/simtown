...
export const broadcast_prompt = (reflections: AiBrainReflections) =>
  `You are an non-playable character agent named ${reflections.name} in an election simulation game and you should generate a speech. Your backstory is ${reflections.backstory} and you have the following plan for the day: ${reflections.currentPlan}. Speech should be at least 2 page long`
